...
const AuthProvider = ({ children }) => {
    ...
    //         await fetch('https://assignment-11-server-eight-woad.vercel.app/register', {
    //             method: 'POST',
    //             headers: {
    ...
    useEffect(() => {
        const unSubscribe = onAuthStateChanged(auth, currentUser => {
            ...
            if (currentUser) {
                ...
                axios.post('https://assignment-11-server-eight-woad.vercel.app/jwt', loggedUser, { withCredentials: true })
                    .then(res => {
                ...
                axios.post('https://assignment-11-server-eight-woad.vercel.app/logout', loggedUser, {
